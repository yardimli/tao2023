...
class HeaderController extends Controller
{
    ...
    public function index($locale,$pageName)
    {
    	...
    	$mainPages = ['index','404','archive','author','author_info','categories','contact','search','single','typography','welcome','register','login','edit_password','edit_profile','insertStories'];
